...
const Temp = ({
  ...
  return (
    <div className="icon">
      ...
      { icon?.level == 1 && <img src={Temp1} alt="icon" id="Temp1" /> }
      { icon?.level == 2 && <img src={Temp2} alt="icon" id="Temp2" /> }
      { icon?.level == 3 && <img src={Temp3} alt="icon" id="Temp3" /> }
      { icon?.level == 4 && <img src={Temp4} alt="icon" id="Temp4" /> }
      { icon?.level == 5 && <img src={Temp5} alt="icon" id="Temp5" /> }
